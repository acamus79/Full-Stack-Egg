...
SELECT nombre AS "Nombre", sal_emp AS "Salario", comision_emp AS "Comision", (sal_emp + comision_emp + 500) AS "Salario + Comision + Bonificación" FROM personal.empleados WHERE id_depto = 3000 ORDER BY nombre;
